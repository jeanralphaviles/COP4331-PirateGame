...
public final class ConjureShoes extends ItemAbility {
	...
	public ConjureShoes() {
		super(new TakeableItem(SlotCategory.FOOT, Decal.createDecal(Decal.shoes), "Conjured Shoes", new Statistics(0, 2, 2, 0, 1, 0 ,0 ,0, 0)), "Conjure Shoes", Decal.createDecal(Decal.item_default));
